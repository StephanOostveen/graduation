...
\begin{table}[htb]
    ...
    \begin{tabular}{llll}
    \toprule
    \rowcolor{white}Priority & Task                       & Trigger            & Description                                                                                                                \\ \midrule
    ...
    $6\dotsc6+n$   & Application tasks          & Angular            & Handles application processing                                                                                             \\
    ...
    1        & CCP task                   & 5ms periodic       & \begin{tabular}[c]{@{}l@{}}Handles the CAN Calibration Protocol messaging to \\ and from the calibration tool\end{tabular} \\ \bottomrule
    \end{tabular}%
    }
    \caption{Real-time operating system and application tasks for OpenECU M560 and M130 as defined by OpenECU documentation, with $n$ the number of user defined tasks.}
