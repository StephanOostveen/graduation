...
\usepackage{a4wide,graphicx,fancyhdr,amsmath,amssymb,csquotes,caption, subcaption, url,hyperref,booktabs,longtable,rotating,array}
...
\begin{document}
	...
	\input{./2.0.problem_statement.tex}
	\input{./3.0.sota_analysis.tex}
	\input{./4.0.research_description.tex}
	\input{./5.0.feasibility_experiments.tex}
	\input{./6.0.planning.tex}
	\newpage
	\printbibliography
\end{document}